...
```
You must share your work on the semester project in a GitHub repository. During the semester you will be asked to share your work with your class-mates. Typically in relation to mandatory assignments 😊 So make sure to structure it for others to read later.
```
